...
export async function PATCH(req: Request) {
  ...
  const allowed = ['fullName', 'hostName', 'showName', 'showDescription', 'targetAudience', 'brandColors', 'brandLogoUrl', 'brandAppName', 'notifyTeamOnAvailability', 'onboardingComplete', 'skippedDnaSetup', 'language', 'seenWizardIntro', 'trialEndedNoticeShown']
