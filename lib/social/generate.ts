...
- MINIMALISM IS THE RULE: the image is the headline as the HERO in a HUGE font, with almost no other text. The reader gets the whole message in one glance. Less text is always better.
- headline: VERY SHORT and punchy, ideally 2 to 5 words (hard max 6) so it renders huge. This is the focal point of the whole post.
- subline: keep it VERY short (a few words, under ~6 words) or OMIT it entirely if the headline carries the message. Never write a full sentence here.
